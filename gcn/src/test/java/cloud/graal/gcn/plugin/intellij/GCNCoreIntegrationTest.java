...
public class GCNCoreIntegrationTest {
    ...
    void applicationContextCreated() {
        ...
        GcnProjectCreator projectCreator = context.getBean(GcnProjectCreator.class);
        assertNotNull(projectCreator, "Failed to get GcnProjectCreator instance");
    }
    ...
    void listApplicationTypes() {
        GcnProjectType[] projectTypes = GcnProjectType.values();
        ...
        boolean contains = false;
        for (GcnProjectType applicationType : projectTypes) {
